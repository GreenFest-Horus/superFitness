...
var _initSwipers = require("./modules/slider/init-swipers");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/slider/init-swipers":11,"./modules/tabs/init-tabs":12,"./modules/video/video":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
var initSwipers = function initSwipers() {
  ...
  if (document.querySelector('.comments__swiper')) {
    var commentsSwiper = new Swiper('.comments__swiper', {
      // eslint-disable-line
      direction: 'horizontal',
      loop: false,
      slidesPerView: 'auto',
...
var video = document.querySelector('[data-video-container]');
var link = document.querySelector('[data-video-link]');
var button = document.querySelector('[data-video-button]');
var iframeBlock = video.querySelector('[data-video-frame]');
